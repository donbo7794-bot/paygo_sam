...
export default function UpgradePaymentPage() {
  ...
  const handleCopyAccountNumber = () => {
    navigator.clipboard.writeText("3193895997")
        ...
        <div className="border border-gray-300 rounded-md overflow-hidden mb-4">
          <div className="bg-gray-100 p-3 space-y-4">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="font-bold">3193895997</p>
                <button
            ...
            <div>
              ...
              <p className="font-bold">TENN MFB</p>
            </div>
            ...
            <div>
              ...
              <p className="font-bold">Paygo-DAMILOLA DAPO IYASERE</p>
            </div>
          </div>
